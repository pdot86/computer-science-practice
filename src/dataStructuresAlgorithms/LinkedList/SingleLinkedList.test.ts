...
describe('SingleLinkedList', () => {
  ...
  describe('.insert(item: { data: any }, before: SingleLinkedListItem | null = null, after: SingleLinkedListItem | null = null): SingleLinkedList', () => {
  ...
  describe('insertAfter(item: { data: any }, after: SingleLinkedListItem): SingleLinkedList', () => {
  ...
  describe('insertBefore(item: { data: any }, before: SingleLinkedListItem): SingleLinkedList', () => {
  ...
  describe('rotate(n: number): SingleLinkedList', () => {
